...
import { manifestsToEntities, serviceResourceId, type ServiceManifest } from "../../../packages/auth/manifest.ts";
import { authorize } from "../../../packages/authz/authorize.ts";
import { connectorsToEntities } from "../../../packages/connectors/registry.ts";
