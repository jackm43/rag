...
import { loadConfig, resetConfigCache } from "../../../packages/ai/config.ts";
import responseConfig from "../../../packages/ai/ai-config/discord-response.json";
import askWebSearchConfig from "../../../packages/ai/ai-config/ask-web-search.json";
import responseSystemPrompt from "../../../packages/ai/ai-config/discord-response-system-prompt.md";
import askWebSearchSystemPrompt from "../../../packages/ai/ai-config/ask-web-search-system-prompt.md";
