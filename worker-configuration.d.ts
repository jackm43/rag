/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 19a268685d3f1f2d361c875a450c9e20)
// Runtime types generated with workerd@1.20260617.1 2026-04-23 nodejs_compat
interface __BaseEnv_Env {
	...
	ASSISTANT_WORKFLOW: Workflow<Parameters<import("./src/index").AssistantWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCOUNT_ID" | "DISCORD_APPLICATION_ID" | "DISCORD_PUBLIC_KEY" | "DISCORD_BOT_TOKEN" | "CLIENT_ID" | "CLIENT_SECRET" | "CF_AIG_TOKEN">> {}
}
declare module "*.md" {
	const value: string;
