  ...
  "paths": {
    ...
    "/api/connectors": {
      "get": {
        ...
        "description": "Read-only management listing of the broker's connectors and their status. Proxied to the connectors broker's admin_list operation over its service binding; no secret material is ever returned.",
        "security": [
          {
            "cfAccess": []
          }
        ...
        "responses": {
          ...
          "403": {
            "description": "Caller not authorized for the management operation."
          },
          "502": {
            "description": "Broker upstream error."
          }
        }
      }
    }
