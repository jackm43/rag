...
export const PUBLIC_KEYRING: Record<MachinePrincipal, JsonWebKey> = {
  ...
  // in the REGISTRY_SIGNING_KEY secret on apps/platform/workers/registry and signs
  ...
  // ATTEST_SIGNING_KEY secret on apps/platform/workers/attest and signs attest ->
  ...
  // METADATA_SIGNING_KEY secret on apps/platform/workers/metadata and signs
  ...
  // DEV_PROXY_SIGNING_KEY secret on apps/connectors/workers/dev-proxy; the gateway's
