...
//     by (connectorId, subject), refreshed via refresh_token on use. No 3LO
//     provider is wired in this task (Discord is a follow-up); the storage +
//     refresh are real so wiring one is only a registry entry.
