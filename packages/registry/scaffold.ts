...
const workerRoot = (id: string) => `workers/applications/${id}`;
...
const serviceServerManifestSource = (metadata: RegistryApplicationMetadata): string => `import type { MachinePrincipal, TrustZone } from "../../../../../packages/auth/principal";
...
const serviceServerHandlersSource = (metadata: RegistryApplicationMetadata): string => {
  ...
  const handlerTypes = `import type { ServiceRequest } from "../../../../../packages/auth";
import type { ApplicationRequestJob } from "../../../../../packages/contracts/types";
...
import { decodeApplicationRequestEnvelope } from "../../../../../packages/contracts";
import type { Env, ServiceMessageBytes } from "../../../../../packages/contracts/types";
