// Discord wire-shape validators for the bot's ingest paths. Moved from the
// old contracts validation module; isRecord stays in @rag/contracts-core.
import { isRecord } from "@rag/contracts-core";
import type { DiscordInteraction, DiscordMessage } from "./index";
