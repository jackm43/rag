import { createServiceServer } from "../../../../packages/auth";
import { decodeWebhookEventEnvelope } from "../../../../packages/contracts";
...
// ai-jobs (packages/domain/consumer.ts): createServiceServer verifies the
