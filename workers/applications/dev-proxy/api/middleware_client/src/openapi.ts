// AUTO-GENERATED from dev-proxy application bindings by
...
export const OPENAPI = {
  ...
  "info": {
    ...
    "description": "Human-facing admin application. Requests first pass Cloudflare Access; command and connector operations additionally require a Better Auth Discord session bound to the Access identity.",
    "version": "2.0.0"
  },
  "servers": [
    {
      ...
      "post": {
        ...
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/GithubApiRequest"
              }
            }
          }
        },
