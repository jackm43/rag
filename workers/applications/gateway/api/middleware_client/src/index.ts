import { ensureRegistered, registryEntities } from "../../../../../../packages/auth";
...
import { publicJwks } from "../../../../../../packages/identity";
...
const router = createGatewayRouter({
  ...
  // by ragbot workers (see packages/identity/token.ts). They intentionally
