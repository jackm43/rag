...
import { handleDevProxyCommand } from "../../../../../packages/domain/devproxy";
import type { DevProxyResult, Env, ServiceMessageBytes } from "../../../../../packages/contracts/types";
...
// with it, so this method is reachable only from workers/applications/dev-proxy — the
