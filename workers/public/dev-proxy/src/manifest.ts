...
// gated by Cloudflare Access + a Better Auth Discord session). Registering the
// manifest lets the registry-driven authorizer derive the dev-proxy → gateway
// hop from attributes as well as the static bootstrap permits.
